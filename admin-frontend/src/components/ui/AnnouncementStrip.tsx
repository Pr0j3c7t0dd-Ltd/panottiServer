...
export default function AnnouncementStrip({ smoothScrollTo }: AnnouncementStripProps) {
  return (
    <div className="bg-black/75 py-2 backdrop-blur-xl">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-center gap-x-6 text-sm">
          ...
          >
            Download Panotti Desktop for macOS  <span aria-hidden="true">→</span>
          </a>
