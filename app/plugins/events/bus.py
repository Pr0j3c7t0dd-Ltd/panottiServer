...
class EventBus:
        ...
        try:
            ...
            if not handlers:
                self.logger.warning(
                    ...
                    extra={"event_name": event.name, "event_id": event_id},
                )
                return
            ...
            if event.priority == EventPriority.CRITICAL:
                ...
                self.logger.debug(
                    ...
                    extra={"event_id": event_id, "handler_count": len(handlers)},
                )
    ...
    def subscribe(self, event_name: str, handler: EventHandler) -> None:
        ...
        self.logger.info(
            ...
            extra={"event_name": event_name, "handler": handler.__qualname__},
        )
